...
CREATE TABLE USERTABLE(										
	...
	,SIGNUPDATE DATE DEFAULT(SYSDATE)--가입 일자
	,DATELOG DATE --접속한 날짜 설정
	,MANNERPOINT NUMBER DEFAULT(0)
	,PROFILE VARCHAR(100)
,CONSTRAINT chk_gender2 CHECK (GENDER IN ('F','M')),
FOREIGN KEY (PROFILE) REFERENCES FILEDATAS(FILENAME) ON DELETE SET NULL
);

INSERT INTO USERTABLE(ID,PASSWORD,NAME,NICKNAME,BIRTH,PHONE,EMAIL,GENDER) values('user1','1234','김씨','제임스','1999-01-01','01011111111','email.com','M');
INSERT INTO USERTABLE(ID,PASSWORD,NAME,NICKNAME,BIRTH,PHONE,EMAIL,GENDER) values('user2','1234','이씨','제이슨','1999-01-01','01011111111','email.com','M');
INSERT INTO USERTABLE(ID,PASSWORD,NAME,NICKNAME,BIRTH,PHONE,EMAIL,GENDER) values('user3','1234','박씨','김길동','1999-01-01','01011111111','email.com','M');
INSERT INTO USERTABLE(ID,PASSWORD,NAME,NICKNAME,BIRTH,PHONE,EMAIL,GENDER) values('user4','1234','최씨','에슐리','1999-01-01','01011111111','email.com','M');
INSERT INTO USERTABLE(ID,PASSWORD,NAME,NICKNAME,BIRTH,PHONE,EMAIL,GENDER) values('user5','1234','김씨','데이비드','1999-01-01','01011111111','email.com','M');
INSERT INTO USERTABLE(ID,PASSWORD,NAME,NICKNAME,BIRTH,PHONE,EMAIL,GENDER) values('user6','1234','최씨','','1999-01-01','01011111111','email.com','M');
...
,FOREIGN KEY (ID) REFERENCES USERTABLE(ID) ON DELETE CASCADE
,FOREIGN KEY (NICKNAME) REFERENCES USERTABLE(NICKNAME) ON DELETE CASCADE
...
CREATE TABLE CLUBBOARD(
	...
	,VIEWED NUMBER --조회수
,FOREIGN KEY (WRITER) REFERENCES USERTABLE(ID) ON DELETE SET NULL
,FOREIGN KEY (NICKNAME) REFERENCES USERTABLE(NICKNAME) ON DELETE SET NULL
,FOREIGN KEY (NUM) REFERENCES CLUB(NUM) ON DELETE CASCADE
...
CREATE TABLE SOCIALCOMMENT(
	...
	,WRITER VARCHAR(100) --글쓴이
	,WRITEDATE DATE DEFAULT(SYSDATE) --글쓴날
,FOREIGN KEY (WRITER) REFERENCES USERTABLE(ID) ON DELETE CASCADE
,FOREIGN KEY (SOCIALNUM) REFERENCES SOCIAL(SOCIALNUM) ON DELETE CASCADE
);
...
,FOREIGN KEY (SENDER) REFERENCES USERTABLE(ID) ON DELETE CASCADE
,FOREIGN KEY (RECEIVER) REFERENCES USERTABLE(ID) ON DELETE CASCADE
);
